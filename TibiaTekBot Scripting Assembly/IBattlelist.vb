...
#Region " Properties "
    ...
    ReadOnly Property GetDistanceFromLocation(ByVal Loc As ITibiaTekBot.LocationDefinition, Optional ByVal IncludeFloor As Boolean = False, Optional ByVal CurrentIndex As Boolean = False) As Double
    ReadOnly Property IsMyself() As Boolean
    ReadOnly Property GetLocation() As ITibiaTekBot.LocationDefinition
...
#Region " Methods "
	...
	Function Find(ByVal Location As ITibiaTekBot.LocationDefinition, Optional ByVal MustBeOnScreen As Boolean = False) As Boolean
