...
namespace TibiaTekBot2 {

//#define TIBIA810 //i cant figure out where u define it, so im just making my life a bit easier

#ifdef TIBIA810

//const int * const CODECAVE = (int*)0x76DA20; Now irrelevant, using tibias own sockets we can communicate between the dll and ttb faster
//const int * const XTEAKEY = (int*)0x768C7C;// Updated to 8.10
//const int * const SOCKETADDR = (int*)0x768C50;// Updated to 8.10
const int * const WASDPOPUP = (int*)0x76C328; //Updated to 8.10
const int * const INGAME = (int*)0x76C2C8;// Updated to 8.10
//#define BUFFERADDR (0x768442)// Updated to 8.10
