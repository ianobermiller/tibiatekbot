...
Public Class Win32API
    ...
    Public Declare Function ReadProcessMemory Lib "kernel32" (ByVal hProcess As Int32, ByVal lpBaseAddress As Int32, ByRef lpBuffer() As Byte, ByVal nSize As Int32, ByVal lpNumberOfBytesWritten As Int32) As Long
    ...
    Public Declare Function VirtualProtectEx Lib "kernel32" (ByVal hProcess As IntPtr, ByVal lpAddress As IntPtr, ByVal dwSize As UIntPtr, ByVal flNewProtect As Integer, ByRef lpflOldProtect As Integer) As Boolean
    Public Declare Function SetWindowLong Lib "user32" (ByVal hWnd As Integer, ByVal nIndex As Integer, ByVal dwNew As Integer) As Integer
    ...
    Public Declare Function SendMessageTimeout Lib "user32" Alias "SendMessageTimeoutA" (ByVal hWnd As IntPtr, ByVal wMsg As Integer, ByVal wParam As Integer, ByVal lParam As Integer, ByVal uFlags As Integer, ByVal uTimeout As Integer, ByRef lpdwResult As Integer) As Integer
    ...
    Public Structure FlashWInfo
        ...
        Sub New(ByVal Initialize As Boolean)
            If Initialize Then cbSize = Convert.ToUInt32(Marshal.SizeOf(GetType(FlashWInfo)))
        End Sub
    ...
    Public Enum ShowState As Integer
        SW_HIDE = 0
        SW_SHOWNORMAL = 1
        SW_SHOWMINIMIZED = 2
        SW_SHOWMAXIMIZED = 3
