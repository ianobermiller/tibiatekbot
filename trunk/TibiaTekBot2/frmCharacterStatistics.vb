    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        Try
            ...
            Else
                ...
                End If
                Core.ReadMemory(Consts.ptrMagicLevelPercent, InitialMagicLevelPercent, 1)
            End If

            ' Fist
            Core.ReadMemory(Consts.ptrSkillsBegin + (Skills.FistFighting * Consts.SkillsDist), ActualFist, 1)
            ActualFistLabel.Text = ActualFist.ToString
            Core.ReadMemory(Consts.ptrSkillsPercentBegin + (Skills.FistFighting * Consts.SkillsDist), ActualFistPercent, 1)
            ...
            Else
                ...
                End If
                Core.ReadMemory(Consts.ptrSkillsPercentBegin + (Skills.FistFighting * Consts.SkillsDist), InitialFistPercent, 1)
            End If

            ' Club
            Core.ReadMemory(Consts.ptrSkillsBegin + (Skills.ClubFighting * Consts.SkillsDist), ActualClub, 1)
            ActualClubLabel.Text = ActualClub.ToString
            Core.ReadMemory(Consts.ptrSkillsPercentBegin + (Skills.ClubFighting * Consts.SkillsDist), ActualClubPercent, 1)
            ...
            Else
                ...
                End If
                Core.ReadMemory(Consts.ptrSkillsPercentBegin + (Skills.ClubFighting * Consts.SkillsDist), InitialClubPercent, 1)
            End If

            ' Axe
            Core.ReadMemory(Consts.ptrSkillsBegin + (Skills.AxeFighting * Consts.SkillsDist), ActualAxe, 1)
            ActualAxeLabel.Text = ActualAxe.ToString
            Core.ReadMemory(Consts.ptrSkillsPercentBegin + (Skills.AxeFighting * Consts.SkillsDist), ActualAxePercent, 1)
            ...
            Else
                ...
                End If
                Core.ReadMemory(Consts.ptrSkillsPercentBegin + (Skills.AxeFighting * Consts.SkillsDist), InitialAxePercent, 1)
            End If

            ' Sword
            Core.ReadMemory(Consts.ptrSkillsBegin + (Skills.SwordFighting * Consts.SkillsDist), ActualSword, 1)
            ActualSwordLabel.Text = ActualSword.ToString
            Core.ReadMemory(Consts.ptrSkillsPercentBegin + (Skills.SwordFighting * Consts.SkillsDist), ActualSwordPercent, 1)
            ...
            Else
                ...
                End If
                Core.ReadMemory(Consts.ptrSkillsPercentBegin + (Skills.SwordFighting * Consts.SkillsDist), InitialSwordPercent, 1)
            End If

            ' Distance
            Core.ReadMemory(Consts.ptrSkillsBegin + (Skills.DistanceFighting * Consts.SkillsDist), ActualDistance, 1)
            ActualDistanceLabel.Text = ActualDistance.ToString
            Core.ReadMemory(Consts.ptrSkillsPercentBegin + (Skills.DistanceFighting * Consts.SkillsDist), ActualDistancePercent, 1)
            ...
            Else
                ...
                End If
                Core.ReadMemory(Consts.ptrSkillsPercentBegin + (Skills.DistanceFighting * Consts.SkillsDist), InitialDistancePercent, 1)
            End If

            ' Shielding
            Core.ReadMemory(Consts.ptrSkillsBegin + (Skills.Shielding * Consts.SkillsDist), ActualShielding, 1)
            ActualShieldingLabel.Text = ActualShielding.ToString
            Core.ReadMemory(Consts.ptrSkillsPercentBegin + (Skills.Shielding * Consts.SkillsDist), ActualShieldingPercent, 1)
            ...
            Else
                ...
                End If
                Core.ReadMemory(Consts.ptrSkillsPercentBegin + (Skills.Shielding * Consts.SkillsDist), InitialShieldingPercent, 1)
            End If

            ' Fishing
            Core.ReadMemory(Consts.ptrSkillsBegin + (Skills.Fishing * Consts.SkillsDist), ActualFishing, 1)
            ActualFishingLabel.Text = ActualFishing.ToString
            Core.ReadMemory(Consts.ptrSkillsPercentBegin + (Skills.Fishing * Consts.SkillsDist), ActualFishingPercent, 1)
            ...
            Else
                ...
                End If
                Core.ReadMemory(Consts.ptrSkillsPercentBegin + (Skills.Fishing * Consts.SkillsDist), InitialFishingPercent, 1)
            End If

            ' Stats
            Core.ReadMemory(Consts.ptrMaxHitPoints, HitPointsMax, 4)
            Core.ReadMemory(Consts.ptrMaxManaPoints, ManaPointsMax, 4)
