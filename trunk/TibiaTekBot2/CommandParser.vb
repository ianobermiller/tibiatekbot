...
#Region " Help Command "
    ...
    Private Sub CmdHelp(ByVal Arguments As GroupCollection)
        ...
        Select Case Topic
            Case "light"
                Core.ConsoleWrite("«Light Effect»" & Ret & _
            ...
            Case "exp"
                Core.ConsoleWrite("«Experience Checker»" & Ret & _
            ...
            Case "trainer"
                Core.ConsoleWrite("«Auto Trainer»" & Ret & _
            ...
            Case "attack"
                Core.ConsoleWrite("«Auto Attacker»" & Ret & _
            ...
            Case "spell"
                Core.ConsoleWrite("«Spell Caster»" & Ret & _
                ...
                "wasted mana!")
            Case "eat"
                Core.ConsoleWrite("«Auto Eater/Smart Eater»" & Ret & _
            ...
            Case "uh"
                Core.ConsoleWrite("«Auto UHer»" & Ret & _
                ...
                "appens!")
            Case "look"
                Core.ConsoleWrite("«Floor Explorer»" & Ret & _
            ...
            Case "fisher"
                Core.ConsoleWrite("«Auto Fisher»" & Ret & _
            ...
            Case "runemaker"
                Core.ConsoleWrite("«Runemaker»" & Ret & _
            ...
            Case "char"
                Core.ConsoleWrite("«Character Information Lookup»" & Ret & _
            ...
            Case "open"
                Core.ConsoleWrite("«Open File/Website»" & Ret & _
            ...
            Case "pickup"
                Core.ConsoleWrite("«Auto Pickup»" & Ret & _
            ...
            Case "ammorestacker"
                Core.ConsoleWrite("«Auto Ammunition Restacker»" & Ret & _
            ...
            Case "log"
                Core.ConsoleWrite("«Events Logging»" & Ret & _
            ...
            Case "healfriend"
                Core.ConsoleWrite("«Auto Heal Friend»" & Ret & _
            ...
            Case "guild"
                Core.ConsoleWrite("«Guild Members Lookup»" & Ret & _
            ...
            Case "heal"
                Core.ConsoleWrite("«Auto Healer»" & Ret & _
            ...
            Case "healparty"
                Core.ConsoleWrite("«Auto Heal Party»" & Ret & _
            ...
            Case "loot"
                Core.ConsoleWrite("«Auto Looter»" & Ret & _
            ...
            Case "statsuploader"
                Core.ConsoleWrite("«Stats Uploader»" & Ret & _
            ...
            Case "mapviewer"
                Core.ConsoleWrite("«Map Viewer»" & Ret & _
            ...
            Case "chameleon"
                Core.ConsoleWrite("«Chameleon»" & Ret & _
            ...
            Case "watch"
                Core.ConsoleWrite("«Trade Channel Watcher»" & Ret & _
            ...
            Case "reload"
                Core.ConsoleWrite("«Reload Data»" & Ret & _
            ...
            Case "list"
                Core.ConsoleWrite("«Commands List»" & Ret & _
                "Usage: &list." & Ret & _
                "Example: &list." & Ret & _
                "Comment:" & Ret & _
                "  Use this command to view all the bot's commands (In alphaphetical order).")
            Case "sendlocation"
                Core.ConsoleWrite("«Send Location»" & Ret & _
            ...
            Case "rainbow"
                Core.ConsoleWrite("«Rainbow Outfit»" & Ret & _
            ...
            Case "fpschanger"
                Core.ConsoleWrite("«FPS Changer»" & Ret & _
            ...
            Case "namespy"
                Core.ConsoleWrite("«Name Spy»" & Ret & _
            ...
            Case "website"
                Core.ConsoleWrite("«Website»" & Ret & _
                "Usage: &website." & Ret & _
                "Example: &website." & Ret & _
                "Comment: " & Ret & _
                "  Opens up TibiaTek Bot's website.")
            Case "drinker"
                Core.ConsoleWrite("«Auto Manafluid Drinker»" & Ret & _
            ...
            Case "walker"
                Core.ConsoleWrite("«Walker»" & Ret & _
