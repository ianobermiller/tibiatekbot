...
#Region " Events "
    ...
    Event ChannelSelfJoinHidden(ByVal Channel As String)
    ...
    Event ChannelSelfKickHidden(ByVal NickKicker As String, ByVal KickMessage As String, ByVal Channel As String)
    ...
    Event ChannelSelfPartHidden(ByVal Channel As String)
    ...
    Event ChannelMessageHidden(ByVal Nick As String, ByVal Message As String, ByVal Channel As String)
...
#Region " Methods "
    ...
    Sub Join(ByVal Channel As String, Optional ByVal Password As String = "")
    Sub JoinHidden(ByVal Channel As String, Optional ByVal Password As String = "")
