Public Module VipListModule
    ...
    Public Class VipList
        ...
        Public ReadOnly Property GetID() As Integer
            Get
                Dim ID As Integer = 0
                Core.Tibia.Memory.Read(Core.Consts.ptrVipListBegin + (Position * Core.Consts.VipDist), ID, 4)
                Return CUInt(ID)
            End Get
        End Property
        ...
        Public ReadOnly Property GetName() As String
            Get
                Dim Name As String = ""
                Dim Address As Integer = Core.Consts.ptrVipListBegin + (Position * Core.Consts.VipDist) + Core.Consts.VipNameOffset
                Core.Tibia.Memory.Read(Address, Name)
                Return Name
            End Get
        End Property
        ...
        Public ReadOnly Property IsOnline() As Boolean
            Get
                ...
                Core.Tibia.Memory.Read(Core.Consts.ptrVipListBegin + (Position * Core.Consts.VipDist) + Core.Consts.VipStatusOffset, Online, 1)
                Return (Online > 0)
            End Get
        End Property
        ...
        Public Function Find(ByVal Name As String, Optional ByVal MustBeOnline As Boolean = False, Optional ByVal Offset As Integer = 0) As Boolean
            For I As Integer = Offset To Core.Consts.VipMax - 1
        ...
        Public Function Reset(Optional ByVal MustBeOnline As Boolean = False) As Boolean
            If Not MustBeOnline Then
                ...
                Return True
            Else
                For Position = 0 To Core.Consts.VipMax - 1
        ...
        Public Function NextPlayer(Optional ByVal MustBeOnline As Boolean = False) As Boolean
            If Not MustBeOnline Then
                Position += 1
                If Position = Core.Consts.VipMax Then
                    Position -= 1
                    Return False
                Else
                    Return True
            ...
            Else
                For Position = Position + 1 To Core.Consts.VipMax - 1
                    If IsOnline Then Return True
                Next
            End If
            Return False
